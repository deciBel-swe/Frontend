 ...
 */
interface FloatingEmailFieldProps {
  value: string;
 ...
 * />
 */
const FloatingEmailField: React.FC<FloatingEmailFieldProps> = ({
  value,
  onChange,
  onFocus,
  autoComplete = 'email',
...
export default FloatingEmailField;
export const EmailInput = FloatingEmailField;
