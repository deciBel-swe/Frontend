  ...
  return (
    <div className="group cursor-pointer">
      <div className="flex flex-col items-center justify-center min-w-[100px] py-4 px-6">
        <span className="text-text-muted text-sm font-normal mb-1 tracking-wide">
          {text}
        </span>
        <span className="text-text-primary text-3xl font-bold tracking-tight mb-1 tracking-wide transition-colors group-hover:text-text-muted">
          {formatNumber(count)}
        </span>
      </div>
    </div>
