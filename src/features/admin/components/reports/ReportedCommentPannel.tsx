...
/**
 * ReportedCommentPanel - Right column showing comment metadata.
 * Visible only when the report type is COMMENT.
 */
export const ReportedCommentPanel: FC<ReportedCommentPanelProps> = ({ comment }) => {
  const fields = [
  ...
  return (
    <div className="flex-1 min-w-[160px]">
      <p className="text-brand-primary text-sm font-semibold mb-3">Reported comment</p>
