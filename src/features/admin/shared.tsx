...
/**
 * SelectFilter - Dropdown filter control used above tables.
 * Rendered as a styled native <select> for accessibility.
 */
export const SelectFilter: FC<SelectFilterProps> = ({
  ...
  <select
    ...
    className="
      text-xs px-3 py-1.5 rounded border border-border-default
