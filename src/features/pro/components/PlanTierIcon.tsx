 ...
 * Free → purple circle-plus  |  Pro → gold star circle.
 *
 * @example
 * <PlanTierIcon tier="free" />
...
export const PlanTierIcon: FC<PlanTierIconProps> = ({ tier }) => {
  if (tier === 'pro') {
    return (
      <span
        className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-amber-100 text-amber-600 ml-2 shrink-0"
        aria-hidden
      >
